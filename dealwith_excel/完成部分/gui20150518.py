...
class InputDlg(QDialog):  
    def __init__(self,parent=None):  
        ...
        label1=QLabel(self.tr(".xls文件路径".decode("GBK")))  
        label2=QLabel(self.tr("选择Sheet".decode("GBK")))  
        label3=QLabel(self.tr("执行".decode("GBK")))  
        #label4=QLabel(self.tr("身高".decode("GBK")))  
        ...
        nameButton=QPushButton("打开")  
        sexButton=QPushButton("选择")  
