...
class MessageBoxDlg(QDialog):  
    ...
    def slotQuestion(self):  
        button=QMessageBox.question(self,"Question",  
                                    self.tr("已到达文档结尾,是否从头查找?".decode("GBK")),  
    ...
    def slotCritical(self):  
        QMessageBox.critical(self,"Critical",  
                             self.tr("提醒用户一个致命的错误!".decode("GBK")))  
        self.label.setText("Critical MessageBox")  
  
    def slotAbout(self):  
        QMessageBox.about(self,"About",self.tr("About事例".decode("GBK")))  
    ...
    def slotCustom(self):  
        ...
        lockButton=customMsgBox.addButton(self.tr("锁定".decode("GBK")),  
                                          QMessageBox.ActionRole)  
        unlockButton=customMsgBox.addButton(self.tr("解锁".decode("GBK")),  
                                            QMessageBox.ActionRole)  
        cancelButton=customMsgBox.addButton("cancel",QMessageBox.ActionRole)  
  
        customMsgBox.setText(self.tr("这是一个自定义消息框!".decode("GBK")))  
        customMsgBox.exec_()  
